package com.wgy.blog.controller.admin;
...
public class BlogController {
    ...
    public String searchBlogs(@PageableDefault(size = 6, sort = {"updateTime"}, direction = Sort.Direction.DESC) Pageable pageable,
                              BlogQuery blog, Model model){
        model.addAttribute("page", blogService.searchBlog(pageable,blog));
        /*for (Blog b:blogService.listBlog(pageable,blog)
             ) {
            System.out.println(b.isRecommend());
        }*/
